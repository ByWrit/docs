...
1. **Verify your identity**
   ...
   Visit [bywrit.com](https://bywrit.com) and click "Get Verified". You'll complete a one-time KYC check through Didit (government ID + selfie). This takes about 2 minutes.
